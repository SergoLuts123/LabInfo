...
\title{Студента группы 8871 Луценко Сергея Викторовича}
\end{center}
\begin{center}
\title{Задание 1}
\end{center}
...
\draw (0,-5) to [R, l={$R_1$},*-*] (2.5,0);
\draw (2.5,0) to [L, l={$L_1$},*-*] (5,-5);
...
\draw (13,-5) to [L, l_={$L_3$},*-*] (15,-2.5);
\draw (15,-2.5) to [L, l={$L_2$},*-*] (15,0);
